            ...
            <div className="col-12 my-3">
              <div className="pb-5 mb-4">
                ...
                <div hidden={!this.state.edit}>
                  <Input title="Meal Option" placeholder="Ex. Sandwich" disabled={this.selectedRow} 
                    value={this.state.newItem} type="string" 
                    update={(event) => this.setState({newItem: event.target.value})}/>
                  <Input title="Price" placeholder="Ex. 7" 
                    value={(this.state.newPrice===-1)? "" : this.state.newPrice} type="number" 
